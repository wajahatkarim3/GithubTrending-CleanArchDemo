...
class UnbookmarkProjectTest {
    ...
    private lateinit var bookmarkProject: UnbookmarkProject
    ...
    fun setUp() {
        ...
        bookmarkProject = UnbookmarkProject(projectsRepository, postExecutionThread)
    }
    ...
    fun bookmarkProjectCompletes() {
        ...
        val testObserver = bookmarkProject.buildUseCaseCompletable(
                UnbookmarkProject.Params.forProject(ProjectsDataFactory.randomUuid())).test()
